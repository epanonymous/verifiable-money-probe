"""Durably submit and non-destructively poll the deployed Modal collector."""

from __future__ import annotations

from typing import Any

from .contract import RUN_V1, validate_variant

APP_NAME = "vmp-exp4-collect"
...
def submit_collection(
    ...
    *,
    dataset_variant: str = RUN_V1,
) -> str:
    """Spawn one durable deployed-function input and print/return its stable ID."""
    ...
    deployed = modal.Function.from_name(APP_NAME, FUNCTION_NAME)
    function_call = deployed.spawn(which, dataset_variant)
